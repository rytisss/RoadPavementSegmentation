...
def main():
    ...
    for set in sets:
        ...
        outputDir = 'D:/CrackTraining_best_video_cracks200/'
        image_path = 'D:/Sensors_FromIDAACS/major revision/another dataset comparisson/Images/'
        label_path = 'D:/Sensors_FromIDAACS/major revision/another dataset comparisson/Labels/'
