...
def makeGraph(x, y, name, output='', plot_width=8, plot_height=5):
    ...
    ax.plot(xlab, y[5], color="#930000", marker='P', markerfacecolor="#930000", markeredgecolor='#4F0000',
            label=labels[5], markeredgewidth=0.7, markersize=marker_size, linewidth = line_width,alpha=0.8)
    ax.plot(xlab, y[6], color="#F4357F", marker='v', markerfacecolor="#F4357F", markeredgecolor='#681737',
            label=labels[6], markeredgewidth=0.7, markersize=marker_size, linewidth = line_width,alpha=0.8)
...
def AnalyzeArchitecture():
    inputDirs = ['C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_CROSSENTROPY25DICE75_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_CROSSENTROPY50DICE50_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_CROSSENTROPY75DICE25_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_WEIGHTEDCROSSENTROPY25DICE75_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_WEIGHTEDCROSSENTROPY50DICE50_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_WEIGHTEDCROSSENTROPY75DICE25_0_0.001_3/',
                 'C:/Users/Rytis\Desktop/CrackTrainings_best/Set_3/l4k32AutoEncoder4_5x5_SURFACEnDICE_0_0.001_3/']
    ...
    for inputDir in inputDirs:
        ...
        sum_dice = 0.0
        for j in range(0, len(dice_values)):
            sum_dice += dice_values[j]
        print('Average Dice: ' + str(sum_dice / (float)(len(dice_values))))
    output = 'C:/Users/Rytis/Desktop/Straipsniai/Sensors_FromIDAACS/samplesScoresCombo.png'
    name = 'Set_3 Samples Dice Scores'
    makeGraph(inputDirs, all_dice, name, output, 8, 3)
    print('Done!')
