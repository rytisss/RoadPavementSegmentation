...
def DecodingLayerCoordConvSE(input,
                  skippedInput,
                  upSampleSize=2,
                  kernels=8,
                  kernel_size=3,
    ...
    if useLeakyReLU:
        ...
        conv = Activation('relu')(conv)
    output = Squeeze_Excitation(conv)
    return output
...
def DecodingCoordConvLayerResSE(input,
                     skippedInput,
                     upSampleSize=2,
                     kernels=8,
                     kernel_size=3,
...
#CoordConv layers
def EncodingCoordConvLayerSE(input,
                  kernels=8,
                  kernel_size=3,
                  stride=1,
                  max_pool=True,
...
def EncodingCoordConvLayerResAddOpSE(input,
                          kernels=8,
                          kernel_size=3,
                          stride=1,
                          max_pool=True,
...
def AtrousSpatialPyramidPoolCoordConvSE(input,
                          kernels=8,
                          kernel_size=3,
                          useLeakyReLU=False,
                          leakyReLU_alpha=0.3):
